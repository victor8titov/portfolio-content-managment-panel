...
const HomepageForm: FC<{ form: FormInstance }> = ({ form }) => {
  ...
  return (
    <Form
      ...
      <Form.Item name={['title', 'en']} rules={[{ max: 1000, message }]}>
        <Input addonBefore="en" placeholder="Title in English" />
      </Form.Item>

      <Form.Item name={['title', 'ru']} rules={[{ max: 1000, message }]}>
      ...
      <Form.Item name={['subtitle', 'en']} rules={[{ max: 1000, message }]}>
        <Input addonBefore="en" placeholder="Subtitle in English" />
      </Form.Item>

      <Form.Item name={['subtitle', 'ru']} rules={[{ max: 1000, message }]}>
      ...
      <Form.Item name={['description', 'en']} label="en" rules={[{ max: 2000 }]}>
        <TextArea rows={8} placeholder="Description in English" />
      </Form.Item>

      <Form.Item name={['description', 'ru']} label="ru" rules={[{ max: 2000 }]}>
